...
<aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-logo">
            <div class="logo-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" fill="#3b82f6" stroke="#3b82f6" stroke-width="1"/>
                </svg>
            </div>
    ...
    <div class="sidebar-user">
        ...
        <div class="user-info">
            ...
            <div class="user-role-badge manager-badge">Manager</div>
        </div>
    </div>
    <nav class="sidebar-nav">
        <div class="nav-label">Analytics</div>
        <a href="manager_dashboard.php" class="nav-item <?= $currentPage==='manager_dashboard.php'&&!isset($_GET['tab'])?'active':'' ?>">
        ...
        <a href="manager_dashboard.php?tab=trends" class="nav-item <?= isset($_GET['tab'])&&$_GET['tab']==='trends'?'active':'' ?>">
            <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
            <span>Heart Rate Trends</span>
        </a>
        <a href="manager_dashboard.php?tab=rescuers" class="nav-item <?= isset($_GET['tab'])&&$_GET['tab']==='rescuers'?'active':'' ?>">
