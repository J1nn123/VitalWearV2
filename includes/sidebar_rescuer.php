...
<aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-logo">
            <div class="logo-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" fill="#f59e0b" stroke="#f59e0b" stroke-width="1"/>
                </svg>
            </div>
    ...
    <div class="sidebar-user">
        ...
        <div class="user-info">
            ...
            <div class="user-role-badge rescuer-badge">Rescuer</div>
        </div>
    </div>
    <nav class="sidebar-nav">
        <div class="nav-label">Field Operations</div>
        <a href="rescuer_dashboard.php" class="nav-item <?= $currentPage==='rescuer_dashboard.php'?'active':'' ?>">
        ...
        <a href="rescuer_dashboard.php?tab=patients" class="nav-item <?= isset($_GET['tab'])&&$_GET['tab']==='patients'?'active':'' ?>">
        ...
        <a href="rescuer_dashboard.php?tab=report" class="nav-item <?= isset($_GET['tab'])&&$_GET['tab']==='report'?'active':'' ?>">
